      ...
      <div className="flex flex-col justify-center h-screen items-center">
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>Create a new game to start voting</CardDescription>
          </CardHeader>
          <CardContent>
            <div>
              <Label
                htmlFor="name"
                className="font-semibold text-black font-bold"
              >
                Display Name
              </Label>
              <Input
          ...
          <CardFooter className="flex justify-between">
            <Button onClick={handleCreateGame} className="w-full text-lg">
              {loading ? (
                <svg
                  aria-hidden="true"
